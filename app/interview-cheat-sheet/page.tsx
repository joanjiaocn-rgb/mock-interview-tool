...
export const metadata: Metadata = {
  ...
  description: "A simple last-minute English behavioral interview cheat sheet structure.",
  robots: {
    index: false,
    follow: true,
  },
...
export default function InterviewCheatSheetPage() {
  return (
    <main className="main legal-page">
      ...
      <p>The live tool generates this as an export. A useful cheat sheet should include only the questions, stories, phrases, and warnings you will actually review.</p>
